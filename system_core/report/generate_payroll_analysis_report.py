...
def generate_payroll_analysis_report(data):
    print("Start | Generate payroll analysis report", file=sys.stderr)
    ...
    print("Finished | Generate payroll analysis report", file=sys.stderr)
