...
def generate_active_without_payroll_report(data):
    print("Start | Generate list of employees with no earnings report", file=sys.stderr)
    ...
    ws['A3'] = "List of Active Employees with No Earnings"
    ...
    # Save document
    wb.save(REPORT_PATH + "active_without_payroll_report.xlsx")

    print("Finished | Generate list of employees with no earnings report", file=sys.stderr)
